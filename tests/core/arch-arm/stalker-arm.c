...
TESTCASE (flat_code)
{
  g_assert_cmpuint (CODE_SIZE (flat_code), ==, 16);

  guint * code = (guint *) CODE_START (flat_code);
...
TESTCASE (exec_events_generated)
{
  ...
  func = invoke_flat_expecting_return_value (fixture, GUM_EXEC, 2);
  g_assert_cmpuint (fixture->sink->events->len, ==,
     INVOKER_INSN_COUNT + (CODE_SIZE (flat_code) / 4));
...
TESTCASE (block_events_generated)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_BLOCK,
      CODE_START (branch_code), CODE_SIZE (branch_code), 2);
...
TESTCASE (nested_call_events_generated)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_CALL,
      CODE_START (nested_call), CODE_SIZE (nested_call), 4);
...
TESTCASE (nested_ret_events_generated)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_RET,
      CODE_START (nested_call), CODE_SIZE (nested_call), 4);
...
{
  invoke_expecting_return_value (fixture, 0, CODE_START (unmodified_lr),
      CODE_SIZE (unmodified_lr), 0xecececec);
}
...
TESTCASE (excluded_range)
{
  ...
  func = test_arm_stalker_fixture_dup_code (fixture,
      CODE_START (excluded_range), CODE_SIZE (excluded_range));
...
TESTCASE (excluded_range_call_events)
{
  ...
  func = test_arm_stalker_fixture_dup_code (fixture,
      CODE_START (excluded_range_call), CODE_SIZE (excluded_range_call));
...
{
  StalkerTestFunc func = test_arm_stalker_fixture_dup_code (fixture,
      CODE_START (excluded_range_call), CODE_SIZE (excluded_range_call));
...
TESTCASE (pop_pc_ret_events_generated)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_RET, CODE_START (pop_pc),
      CODE_SIZE (pop_pc), 2);
...
TESTCASE (pop_just_pc_ret_events_generated)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_RET,
      CODE_START (pop_just_pc), CODE_SIZE (pop_just_pc), 2);
...
TESTCASE (ldm_pc_ret_events_generated)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_RET, CODE_START (ldm_pc),
      CODESIZE (ldm_pc), 2);
...
TESTCASE (branch_cc_block_events_generated)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_BLOCK, CODE_START (b_cc),
      CODE_SIZE (b_cc), 10);
...
TESTCASE (branch_link_cc_block_events_generated)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_CALL, CODE_START (bl_cc),
      CODE_SIZE (bl_cc), 5);
...
TESTCASE (cc_excluded_range)
{
  ...
  func = test_arm_stalker_fixture_dup_code (fixture,
      CODE_START (cc_excluded_range), CODE_SIZE (cc_excluded_range));
...
TESTCASE (excluded_thumb)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_CALL,
      CODE_START (excluded_thumb), CODE_SIZE (excluded_thumb), 4);
...
TESTCASE (excluded_thumb_branch)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_CALL,
      CODE_START (excluded_thumb_branch), CODE_SIZE (excluded_thumb_branch), 3);
...
TESTCASE (ldr_pc)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_BLOCK, CODE_START (ldr_pc),
      CODE_SIZE (ldr_pc), 2);
...
TESTCASE (sub_pc)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_BLOCK, CODE_START (sub_pc),
      CODE_SIZE (sub_pc), 2);
...
TESTCASE (add_pc)
{
  ...
  func = invoke_expecting_return_value (fixture, GUM_BLOCK, CODE_START (add_pc),
      CODE_SIZE (add_pc), 2);
